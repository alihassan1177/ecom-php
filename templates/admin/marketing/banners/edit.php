...
<div class="row col-md-8 mb-5">
    <form id="banner-form" enctype="multipart/form-data" style="gap:30px 0px" class="row">
        ...
        <div class="col-12">
            ...
            <input name="heading" value="<?= html_entity_decode($banner["heading"])  ?>" type="text" id="heading" class="form-control form-control-user">
        </div>
        <div class="col-md-6">
            <label for="image" class="form-label">Sub Heading</label>
            <input type="text" value="<?= html_entity_decode($banner["sub_heading"])  ?>" class="form-control" name="sub-heading">
        </div>
        <div class="col-md-6">
            <label for="image" class="form-label">Button Text</label>
            <input type="text" value="<?= html_entity_decode($banner["btn_text"])  ?>" class="form-control" name="btn-text">
        </div>
        <div class="col-12">
            <label for="image" class="form-label">Button Link</label>
            <input type="text" value="<?= html_entity_decode($banner["btn_link"])  ?>" class="form-control" name="btn-link">
        </div>
