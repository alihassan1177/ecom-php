...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/admin/products/edit?id=<?= $category["id"] ?>" class="d-none d-sm-inline-block btn mx-2 btn-sm btn-primary shadow-sm">
        <i class="fas fa-download fa-sm text-white-50"></i> Edit Category</a>
    <a href="/admin/products/delete?id=<?= $category["id"] ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
